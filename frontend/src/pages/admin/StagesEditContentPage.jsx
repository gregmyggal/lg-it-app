...
const SECTIONS = [
  ...
  { id: 'infos', label: 'Dates & tarifs', icon: '💰', color: '#0891b2' },
  { id: 'inclus', label: 'Inclus', icon: '✓', color: '#059669' },
];
      ...
      <div style={{ background: 'white', borderBottom: '1px solid #e5e7eb', padding: '32px 24px', position: 'sticky', top: 0, zIndex: 100 }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ margin: 0, fontSize: '15px', color: '#6b7280' }}>Personnalisez chaque section pour {stage.titre}</p>
          </div>
          <button
